...
date: 2023-03-23 8:23:16 -0600
tags: [tinkering]
image: /assets/quickswitch/all_accessories.jpg
---

I recently made a system for quickly switching my disc golf retriever accessories ([link](/projects/quick-switch-disc-golf-retriever)). My Rogue Iron retriever seems strong and I've never had issues with it - but I have seen other retrievers break before. I wanted to run some numbers and see how much extra stress I may be putting on my retriever with my change.

<!--more-->

I started by weighing each of my retriever accessories. I weighed the wingnut which comes with the Rogue Iron accessories to compare:
...
| Suction Cup Ball | 63g | 66.2g | 70.8g | 96.9g |
...
<div class="flex-pair">
    <img src='/assets/quickswitch/v0_prototype_parts.png' alt='v0 prototype parts' />
    <span>
        The part on the left is what I cut off of the original Rogue Iron retriever. The part on the right is what I added by cross-drilling a hole and pinning with a cotter pin.
    </span>
</div>
...
<div class="flex-pair">
    ...
    <img src='/assets/quickswitch/v1_prototype.png' alt='v1 prototype' />
</div>

This gave me some final results on how much each accessory might weigh with the heavier (non-destructive-install) retriever adapter. For this I only worried about my shortest and longest accessory adapters.
