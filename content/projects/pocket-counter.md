...
repo: https://github.com/charliewynn/pocket_counter
featured: true
---
...
I decided it would be a good idea to keep some microcontrollers around the house. When I ordered a PCB for my Washing Machine Project I ended up with a handful of 8-segment displays ([See the washing machine post](/projects/washing-machine-drain-overflow-auto-cutoff) | [See the PCB post](/projects/pcb-for-washing-machine-overflow)).
...
<div class="gallery">
<img src="/assets/pocket_counter/buttons_and_led.jpg" alt="Buttons and Led on Board" />
<img src="/assets/pocket_counter/buttons_and_led_side.jpg" alt="Side View of Board" />
<img src="/assets/pocket_counter/two_counters.jpg" alt="PCB Planning" />
</div>
