...
repo: https://github.com/charliewynn/garage-kitchen-monitor
featured: true
---
...
Unfortunately a collision occurs <!--more--> when I open that door if my wife has left the bi-fold door to the laundry closet, or the right refrigerator door, or either of the two nearby drawers open.
...
After playing around for a few hours I had a prototype on breadboards. I'd been watching some [Ben Eater breadboard computer tutorials](https://www.youtube.com/playlist?list=PLowKtXNTBypGqImE405J2565dvjafglHU) and liked how he breaks sub-modules of a circuit out onto separate boards. It got me thinking about separating test inputs (a sub-board with switches) from real inputs (the sensors installed in my house). This project isn't really complicated enough to need that, but I did it anyway and it was almost immediately useful. I still don't know when to make the switch from quick-and-dirty to laid-out-nicely.
...
<div class="gallery">
<img src="/assets/garagedoormonitor/drawer_sensor.jpg" alt="door sensor" />
<img src="/assets/garagedoormonitor/drawer_sensor_pad.jpg" alt="door sensor pad" />
</div>
...
<div class="gallery">
<img src="/assets/garagedoormonitor/bifold_opened.jpg" alt="bifold open" />
<img src="/assets/garagedoormonitor/bifold_closed.jpg" alt="bifold closed" />
</div>

You can see as it goes between opened and closed the tilt-sensor is activated (take my word for it). The signal wire was affecting the swinging too much so I had to add a lug-nut and some machine nuts to help weigh it down and keep the swing consistent.
...
I put each of these as separate inputs into the pico and wrote some code ([Click here to see the code on github](https://github.com/charliewynn/garage-kitchen-monitor/blob/main/kitchen_garage_door/kitchen_garage_door.ino)).
...
<div class="gallery">
<img src="/assets/garagedoormonitor/led.jpg" alt="outled open led" />
<img src="/assets/garagedoormonitor/outlet_led.jpg" alt="outled led" />
</div>
...
<div class="gallery">
<img src="/assets/garagedoormonitor/final_red.jpg" alt="final red" />
<img src="/assets/garagedoormonitor/final_all_clear.jpg" alt="final all clear" />
</div>
